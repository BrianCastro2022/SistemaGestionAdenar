...
export default function CrearEvaluacion({ colaboradores }: { colaboradores: ColaboradorOption[] }) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <HeadingSmall
                    ...
                    description="Selecciona el colaborador y el tipo de evaluación — los exámenes requeridos se generan automáticamente según su cargo."
                />
                ...
                <form onSubmit={submit} className="grid max-w-lg gap-6">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Select
                            ...
                            onValueChange={(value) => setData('tipo_evaluacion', value as FormData['tipo_evaluacion'])}
                            disabled={processing}
                        >
