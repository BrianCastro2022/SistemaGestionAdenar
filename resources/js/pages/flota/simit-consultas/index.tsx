...
export default function SimitConsultasIndex({ consultas, filters }: { consultas: ConsultasPaginator; filters: Filters }) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4">
                <HeadingSmall
                    ...
                    description="Historial de consultas de comparendos por placa, capturado automáticamente cada día."
                />
                            ...
                            {consultas.data.map((consulta, index) => (
                                <TableRow key={consulta.id}>
                                    ...
                                    <TableCell className="text-right">
                                        {consulta.screenshot_nombre ? (
                                            <Button
                                                type="button"
                                                variant="ghost"
                                                size="icon"
                                                aria-label="Ver pantallazo"
                                                onClick={() =>
                                                    setPreview({
                                                        consulta,
                                                        url: route('flota.simit-consultas.screenshot', consulta.id),
                                                    })
                                                }
                                            >
