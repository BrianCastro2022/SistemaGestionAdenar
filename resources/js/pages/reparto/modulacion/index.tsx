                    ...
                    <Card className="shadow-sm border-t-4 border-t-red-600 relative">
                        ...
                        <CardContent className="space-y-6 pt-4">
                            ...
                            <div className="p-4 bg-red-50/50 dark:bg-red-950/20 rounded-lg border border-red-100 dark:border-red-900/40 space-y-4">
                                ...
                                {/* Fila 1: Fecha, Programado Por, Despachado Por */}
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <Label htmlFor="fecha-edicion" className="text-xs font-semibold uppercase tracking-wider text-gray-700 dark:text-gray-300 flex items-center gap-1.5">
